      ...
      child: StreamBuilder(
          ...
          builder: (context, snapshot) {
            if (!snapshot.hasData) {
              ...
              return InkWell(
                onTap: () {
                  if(snapshot.data![FirebaseConstants.fieldCommunityAdminId]==UserDbFunctions().userId){
                    Navigator.of(context).push(MaterialPageRoute(
                      builder: (ctx) => CommunityDetailsAdmin(
                            ...
                            communityName: snapshot
                                ...
                                isPrivate: snapshot.data![FirebaseConstants.fieldCommunityPrivate],
                                communityDescription: snapshot.data![FirebaseConstants.fieldCommunityDescription],
                          )));
                  }else{
                    Navigator.of(context).push(MaterialPageRoute(
