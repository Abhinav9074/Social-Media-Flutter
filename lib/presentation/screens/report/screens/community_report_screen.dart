...
class CommunityReportPage extends StatelessWidget {
  ...
  const CommunityReportPage({super.key, required this.communityId});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Report Community',style: MyTextStyle.discussionHeadingText,),
      ),
      body:  Column(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: ()async{
          if(textCont.text.trim().isNotEmpty){
            await ReportDbFunctions().reportCommunity(communityId: communityId, description: textCont.text);
