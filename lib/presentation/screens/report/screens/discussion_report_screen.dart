...
class DiscussionReportScreen extends StatelessWidget {
  final String discussionId;

  const DiscussionReportScreen({super.key, required this.discussionId});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Report Discussion',style: MyTextStyle.discussionHeadingText,),
      ),
      body:  Column(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: ()async{
          if(textCont.text.trim().isNotEmpty){
            await ReportDbFunctions().reportDiscussion(discussionId: discussionId, description: textCont.text);
